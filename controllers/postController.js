...
const createPost = asyncHandler(async (req, res) => {
  ...
  return res
    .status(201)
    .json(new ApiResponse(201, "Post created successfully", postDetails));
});
...
const deletePost = asyncHandler(async (req, res) => {
  if (!req.userData) throw new ApiError(401, "Unauthorized request");

  const { postId } = req.params;
  if (!postId) throw new ApiError(400, "Post id is required to delete a post");
...
export { createPost, viewPost,deletePost };
